/************************************************************************/
/*      Archivo:                pregunta_NEGOCIOS.sp                    */
/*      Stored procedure:       sp_pregunta_NEGOCIOS                    */
/*      Base de datos:          cob_credito                             */
/*      Producto:               CREDITO                                 */
/*      Disenado por:           Jose Escobar                            */
/*      Fecha de escritura:     08-May-2019                             */
/************************************************************************/
/*                            IMPORTANTE                                */
...
/*  puntuación del cliente del producto NEGOCIOS para flujo INDIVUAL    */
/*                                                                      */
/************************************************************************/
/*                           MODIFICACIONES                             */
/*    FECHA           AUTOR            RAZON                            */
/*  08/05/2019      José Escobar    Emisión Inicial                     */
/************************************************************************/
use cob_credito
go

if exists (select 1 from   sysobjects where  name = 'sp_pregunta_NEGOCIOS')
    drop proc sp_pregunta_NEGOCIOS
go

create proc sp_pregunta_NEGOCIOS (
...
set @w_sp_name = 'sp_pregunta_NEGOCIOS'
...
begin
    ...
    if exists( select 1
               ...
               and   dd_producto     = @i_producto --'NEGOCIOS'
