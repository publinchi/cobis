...
/*      Stored procedure:               sp_query_tramite_busin         */
...
/*      Abr/2006        Viviana Arias           D¡as a prorrogar para  */
/*                                              reestructuraciones.    */
...
/*                                     operacion de factoring es compra-*/
/*                                     da por el banco o no. VERSION   */
/*                                     FACTORING.                      */
...
/*      17/Juli/2019    Jonathan Tomala Consulta de datos del seguro   */
/*      13/Sept/2019    Jonathan Tomala retorno del numero de operacion*/
/***********************************************************************/
use cob_credito
go

IF OBJECT_ID ('dbo.sp_query_tramite_busin') IS NOT NULL
...
--@w_des_cupos_terceros   descripcion,
--@w_tamano_empresa       catalogo,
--@w_des_tamano_empresa   descripcion,
--@w_referencia_bmi       varchar(30),
---@w_unidad_medida        catalogo,
--@w_des_unidad_medida    descripcion,
--@w_tipo_empresa         catalogo,
--@w_des_tipo_empresa     descripcion,
--@w_tipo_sector          catalogo,
--@w_des_tipo_sector      descripcion,
--@w_cantidad             int,
@w_origen_fondo           catalogo,
@w_des_origen_fondo       descripcion,
@w_fondos_propios         char(1),
--@w_clabas                 catalogo,
--@w_des_clabas             descripcion,
--@w_claope                 catalogo,
--@w_des_claope             descripcion,
--@w_fecha_contrato         datetime,
--@w_cupo_terceros         catalogo,
--@w_des_cupo_terceros     descripcion,
@w_sector_contable       catalogo,
@w_des_sector_contable     descripcion,
@w_plazo                 catalogo,
@w_des_plazo             descripcion,
--@w_uso_financiamiento     descripcion,
--@w_forma_cont             catalogo,
--@w_des_forma_cont         descripcion,
--@w_dias_desembolso         smallint,
--@w_fecha_ins_desembolso datetime,
--@w_tram_anticipo         int,
@w_num_banco_cartera     cuenta,
@w_tipo_top                char(1),
--@w_oficial_conta        smallint,
--@w_des_oficial_conta    descripcion,
--@w_cem                    money, --cem
@w_causa                char(1),      --Personalizacicn Banco Atlantic
@w_migrada                cuenta,        --RZ Personalizacicn Banco Atlantic
@w_lin_op               cuenta,
@w_tipo_prioridad       char(1),
--@w_documento            varchar(10),
--@w_desc_documento       varchar(30),
@w_descripcion          varchar(40),
--@w_fdescuento            catalogo,    --Vivi
--@w_des_fdescuento        descripcion,    --Vivi
--@w_cta_descuento        cuenta,    --Vivi
...
--@w_linea_can_sobvis_str varchar(24),
@w_fecha_irenova        datetime,
@w_subsidio                char(1),
@w_porcentaje_subsidio    float,
--@w_usr_cobro            login,
--w_desc_usr_cobro       descripcion,
...
--@w_compra_operacion     char(1), --SRO Factoring. Version
...
if @t_show_version = 1
begin
    print 'Stored procedure sp_query_tramite_busin, Version 4.0.0.2'
    return 0
end

 --print 'usuario de conecccion ' + @s_user
  --print 'tramiteeee ' + convert(varchar,@i_tramite)
...
SELECT
        ...
        -- @w_aprob_por = tr_aprob_por,
         ...
         --@w_clabas    = tr_clabas,
         --@w_claope    = tr_claope,
         --@w_fecha_contrato = tr_fecha_contrato,
         --@w_tipo_empresa = tr_tipo_empresa,
        -- @w_tamano_empresa = tr_tamano_empresa,
         --@w_unidad_medida = tr_unidad_medida,
         --@w_cantidad = tr_cantidad,
         --@w_uso_financiamiento = tr_uso_financiamiento,
         --@w_forma_cont = tr_forma_cont,
         --@w_dias_desembolso = tr_dias_desembolso,
         --@w_fecha_ins_desembolso = tr_fecha_ins_desembolso,
         --@w_tram_anticipo = tr_tram_anticipo,
         --@w_oficial_conta = tr_oficial_conta,
         --@w_cem    = tr_cem,
         @w_causa = tr_causa,
         --@w_documento= tr_documento,
         --@w_fdescuento       = tr_fdescuento,        --Vivi
         --@w_cta_descuento = tr_cuenta_descuento,    --Vivi
         @w_proposito_op  = tr_proposito_op,        --Vivi
         @w_linea_cancelar= tr_linea_cancelar,
         @w_fecha_irenova = tr_fecha_irenova,
         --@w_usr_cobro     = tr_usr_cobro,
         @w_tasa_asociada = tr_tasa_asociada,
         --@w_medio         = tr_medio,
         --@w_linea_can_sobvis = tr_linea_can_sobvis,
         --@w_anticipo         = tr_tram_anticipo,
         --@w_compra_operacion = tr_compra_operacion,    --SRO 03/27/2009 VERSION. Factoring.
         @w_cuota            = tr_cuota,
...
exec sp_tr_datos_adicionales
    ...
    @i_operacion       = 'S',
     @i_tramite         =@i_tramite,
     @o_tipo_cartera                = @w_tipo_cartera           out,
     @o_destino_descripcion         = @w_destino_descripcion    out,
     @o_mes_cic                     = @w_mes_cic                out,
     @o_anio_cic                    = @w_anio_cic               out,
     @o_patrimonio                  = @w_patrimonio             out,
     @o_ventas                      = @w_ventas                 out,
     @o_num_personal_ocupado        = @w_num_personal_ocupado   out,
     @o_tipo_credito                = @w_tipo_credito           out,
     @o_indice_tamano_actividad     = @w_indice_tamano_actividad out,
     @o_objeto                      = @w_objeto                 out,
     @o_actividad                   = @w_actividad              out,
     @o_descripcion_oficial         = @w_descripcion_oficial    out,
     @o_ventas_anuales              = @w_ventas_anuales         out,    --NMA 10-Abr-2015 datos nuevos en tabla cr_tr_datos adicionales
     @o_activos_productivos         = @w_activos_productivos    out,    --NMA 10-Abr-2015 datos nuevos en tabla cr_tr_datos adicionales
     @o_level_indebtedness          = @w_level_indebtedness     out,
     @o_convenio                    = @w_convenio               out,
     @o_codigo_cliente_empresa      = @w_codigo_cliente_empresa out,
     @o_reprogramingObserv          = @w_reprograming_Observ    out,
     @o_motivo_uno                  = @w_motivo_uno             out,   -- ADCH, 05/10/2015 motivo para tipo de solicitud
     @o_motivo_dos                  = @w_motivo_dos             out,    -- ADCH, 05/10/2015 motivo para tipo de solicitud
     @o_motivo_rechazo              = @w_motivo_rechazo         out,
     @o_producto_fie                = @w_producto_fie           out,
     @o_num_viviendas               = @w_num_viviendas          out,
     @o_tipo_calificacion           = @w_tipo_calificacion      out,
     @o_calificacion                = @w_calificacion           out,
     @o_es_garantia_destino         = @w_es_garantia_destino    out,
     @o_es_deudor_propietario       = @w_es_deudor_propietario  out,
     @o_tamanio_empresa             = @w_tamanio_empresa        out,
     @o_tasa                        = @w_tasa                   out,
     @o_sub_actividad               = @w_sub_actividad          out,
     @o_departamento                = @w_departamento           out
END
...
if @@rowcount = 0
       ...
       where  rt_tramite = @i_tramite
--*******************
               /* select @w_des_clabas = a.valor
                from cobis..cl_catalogo a, cobis..cl_tabla b
                where a.codigo = @w_clabas
                and a.tabla = b.codigo
                and b.tabla = 'cr_clabas'
                select @w_des_claope = a.valor
                from cobis..cl_catalogo a, cobis..cl_tabla b
                where a.codigo = @w_claope
                and a.tabla = b.codigo
                and b.tabla = 'cr_claope'
                select @w_des_forma_cont = a.valor
                from cobis..cl_catalogo a, cobis..cl_tabla b
                where a.codigo = @w_forma_cont
                and a.tabla = b.codigo
                and b.tabla = 'cr_forma_contratacion'
                select @w_des_tipo_empresa = a.valor
                from cobis..cl_catalogo a, cobis..cl_tabla b
                where a.codigo = @w_tipo_empresa
                and a.tabla = b.codigo
                and b.tabla = 'cr_tipo_empresa'
                select @w_des_tamano_empresa = a.valor
                from cobis..cl_catalogo a, cobis..cl_tabla b
                where a.codigo = @w_tamano_empresa
                and a.tabla = b.codigo
                and b.tabla = 'cr_tamano_empresa'
                select @w_des_unidad_medida = a.valor
                from cobis..cl_catalogo a, cobis..cl_tabla b
                where a.codigo = @w_unidad_medida
                and a.tabla = b.codigo
                and b.tabla = 'cr_unidad_medida'*/
...
/*select @w_fecha_contrato = li_fecha_contrato,
       @w_li_num_banco = isnull(@w_li_num_banco, li_num_banco) --SAL 23/11/99
from cob_credito..cr_linea
...
-- nombre del oficial contable
    /*select @w_des_oficial_conta = fu_nombre
    from cobis..cc_oficial, cobis..cl_funcionario
    where oc_oficial = @w_oficial_conta
    and oc_funcionario = fu_funcionario*/
...
-- nombre del usuario que fue sustituido
    /*if @w_aprob_por is not null
        select @w_nom_aprob_por = fu_nombre
...
-- descripcion del tipo de documento
       /* if @w_documento is not null
        begin
                select @w_desc_documento=tc_descripcion
                  from cob_custodia..cu_tipo_custodia
                 where tc_tipo=@w_documento

                select @w_descripcion=@w_documento + '(' + @w_desc_documento + ')'
        end
        else
...
begin
   ...
   select @w_numero_operacion        = op_operacion,
          ...
          @w_cuenta                     = op_cuenta,               -- OBTIENE EL NUMERO DE LA CUENTA PARA EL DEPOSITO
 ...
 --         @w_origen_fondo               = op_origen_fondo,--TCRM
          @w_fondos_propios             = op_fondos_propios,
          --@w_cupo_terceros              = op_cupos_terceros,
/*          @w_sector_contable         = op_sector_contable,
          @w_plazo                      = op_plazo_contable,*/--TCRM
          --@w_destino                  = op_destino,--porque ya toma del tramite actual
          --@w_clabas                     = op_clabas,
          --@w_claope                     = op_clabope,
           @w_num_banco_cartera          = op_banco,
          @w_tipo_top                 = op_tipo,
          @w_migrada                 = op_migrada,        --RZ Banco Atlantic
          /*@w_lin_op                  = op_lin_comext,
          @w_tipo_prioridad          = op_tipo_prioridad,
          @w_subsidio                 = op_subsidio,
          @w_porcentaje_subsidio     = op_porcentaje_subsidio,
          @w_tpreferencial             = op_tpreferencial,
          @w_porcentaje_preferencial = op_porcentaje_preferencial,
          @w_monto_preferencial      = op_monto_preferencial,
          @w_abono_ini                 = op_abono_ini,
          @w_opcion_compra             = op_opcion_compra,
          @w_beneficiario             = op_beneficiario,
          @w_financia                 = op_financia,*/--TCRM
          @w_tipo_amortizacion       = op_tipo_amortizacion,
          --@w_dias_prorroga           = isnull( op_dias_prorroga, 0),--TCRM
          @w_fecha_fin_new           = op_fecha_fin,
        --  @w_efecto_pago             = op_efecto_pago,--TCRM
   ...
   if @w_num_banco_cartera != rtrim(convert(char(24),@w_tramite)) and (@w_numero_op_banco is null or rtrim(@w_numero_op_banco) ='')
       select @w_numero_op_banco = @w_num_banco_cartera

  /* select @w_des_cupo_terceros = a.valor
   from cobis..cl_catalogo a, cobis..cl_tabla b
   where a.codigo = @w_cupo_terceros
     and a.tabla = b.codigo
     and b.tabla = 'ca_cupos_terceros'*/
 ...
 -- descripcion de Origen Fondos
  /*       if @w_fondos_propios = 'S'
              select @w_des_origen_fondo = a.valor
                from cobis..cl_catalogo a, cobis..cl_tabla b
                where a.codigo = @w_origen_fondo
                and a.tabla = b.codigo
                and b.tabla = 'ca_fondos_propios'
        else
                select @w_des_origen_fondo = a.valor
                from cobis..cl_catalogo a, cobis..cl_tabla b
                where a.codigo = @w_origen_fondo
                and a.tabla = b.codigo
                and b.tabla = 'ca_fondos_no_propios'
*/
select  @w_des_origen_fondo = null
   /*select  @w_des_origen_fondo = of_descripcion
   from cob_cartera..ca_origen_fondo
   where of_concepto = @w_origen_fondo
     and of_propio = @w_fondos_propios*/
...
/* =================
print '@w_plazo: '+ @w_plazo +' @w_des_plazo: ' + @w_des_plazo
================= */
...
--Vivi, DESCRIPCION DE LA FORMA DE DESCUENTO
/*select @w_des_fdescuento =  substring(cp_descripcion,1,30)
  from cob_cartera..ca_producto
 where cp_producto = @w_fdescuento
   and cp_moneda   = @w_moneda

if @w_usr_cobro is not NULL
   select @w_desc_usr_cobro=fu_nombre
     from cobis..cl_funcionario
    where fu_login=@w_usr_cobro*/

/*if @w_medio is not NULL
   select @w_medio_desc=id_descripcion
     from cr_imp_documento
    where id_documento=@w_medio*/
...
select @w_asunto =  'Aprobacicn de ' + rtrim(@w_tipo_t) + ', ' + rtrim(@w_tipo_opera_t)
...
begin
   ...
   select @w_asunto = 'Modificacicn de ' +  rtrim(@w_des_clase_asunto)  + ' ' + rtrim(@w_des_tope_asunto) + ' por ' + rtrim(@w_motivo)
end
...
begin
   select @w_des_tope_asunto       = (select valor from cobis..cl_catalogo
          ...
          @w_des_clase_asunto = (select valor from cobis..cl_catalogo   -- actividad
                         where codigo = cr_tramite.tr_toperacion
                           and tabla = (select codigo from cobis..cl_tabla where tabla = 'cr_clase_linea')),
          @w_li_dias = li_dias/*, --Adry
          @w_numero_testimonio = li_numero_testimonio*/
   from cr_linea, cr_tramite
   where li_tramite = @w_tramite
     and tr_tramite = li_tramite
     and tr_tramite = @w_tramite

   select @w_asunto = 'Aprobacicn de ' + rtrim(@w_des_clase_asunto)  + ' ' + rtrim(@w_des_tope_asunto)
end

if @w_tipo = 'G'
begin
   select @w_asunto = 'Aprobacicn de ' + rtrim(@w_tipo_t) + ', ' + rtrim(@w_des_proposito) + ', ' +  rtrim(@w_des_razon)  + '.'
end

--print 'LINEA DE CREDITO.... ' + convert(varchar,@w_linea_credito)

--print 'NUMEOR DE LA LINEA.... ' + @w_li_num_banco
...
-- CONSULTA DE LOS SEGUROS ASOCIADOS
/********* retorno al front-end PART III ****************/
EXEC cob_cartera..sp_seguros_indv @i_opcion = 'S',@i_cliente = @w_cliente, @i_tramite = @w_tramite, @s_user   = @s_user, @t_trn = 77511,
                                  @o_seguro_basico = @w_seguro_basico out, @o_seguro_voluntario =  @w_seguro_voluntario out
...
select
    ...
    @w_tipo_top,         --90
    @w_causa,       --Personalizacicn Banco Atlantic
    ...
    @w_li_dias,  --Adry
    @w_expromision,
    isnull(@w_numero_op, @w_numero_operacion),  --NMA 23-06-2015  -- JTO 13-09-2019 SE NECESITA QUE REGRESE EL NUMERO DE OPERACION, EL @w_numero_op sabe venir nulo
    ...
    @w_tamanio_empresa,
    @w_codigo_usr_con, -- DFL Inicio: Verificar campos con versión CPN
...
/*select @w_linea_can_sobvis_str =li_num_banco
  from cr_linea
 where li_numero=@w_linea_can_sobvis*/
...
/*select @w_etapa_inicial = pa_etapa,
       @w_paso  = pa_paso
...
where rt_tramite = @i_tramite
  and rt_etapa = @w_etapa_inicial
  and rt_paso = @w_paso
  and rt_estacion = @w_estacion
  and rt_salida is null
  and rt_truta = @w_truta


select @w_etapa_inicial = @w_count    */
...
select  @w_linea_cancelar_str,
       ...
       -- @w_medio_desc,
        ...
        @w_tipo_amortizacion,
        @w_dias_prorroga,
        @w_numero_prorrogas,    --20
        @w_dias_a_prorrogar,
        --@w_linea_can_sobvis_str,
        @w_etapa_inicial,        -- SYR 23
        @w_anticipo            -- SYR CD00254
       --@w_compra_operacion,      -- SRO 27/MAR/2009, Factoring
