/************************************************************************/
/*  Archivo:                var_es_partner.sp                           */
/*  Stored procedure:       sp_var_es_partner                           */
...
if exists (select 1 from sysobjects where name = 'sp_var_es_partner' and type = 'P')
   drop proc sp_var_es_partner
go



CREATE PROC sp_var_es_partner
		(@s_ssn        int         = null,
	     @s_ofi        smallint    = null,
	     @s_user       login       = null,
...
SELECT @w_sp_name='sp_var_es_partner'
...
--//////////////////////////////////////////////////
print 'INSTANCIA: ' + convert(VARCHAR,@i_id_inst_proc) +'- CLIENTE -' + convert(VARCHAR,@w_ente) + ' ES PARTENR: ' + @w_valor_nuevo 
