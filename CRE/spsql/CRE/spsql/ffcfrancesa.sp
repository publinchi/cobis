...
if object_id ('sp_ffinanciero_cfrancesa') is not null
    drop procedure sp_ffinanciero_cfrancesa
go
...
select @w_sp_name = 'sp_ffinanciero_cfrancesa'   
...
from   cob_cartera..ca_rubro_op as a inner join cob_cartera..ca_rubro_op as b 
...
exec @w_error = cob_cartera..sp_formula_francesa
