/************************************************************************/
/*  Archivo:                var_porc_atra_cic_indiv_ant.sp              */
/*  Stored procedure:       sp_var_porc_atra_cic_indiv_ant              */
...
if exists (select 1 from sysobjects where name = 'sp_var_porc_atra_cic_indiv_ant' and type = 'P')
   drop proc sp_var_porc_atra_cic_indiv_ant
go


CREATE PROC sp_var_porc_atra_cic_indiv_ant(
    @s_ssn          int         = null,
    @s_ofi          smallint    = null,
    @s_user         login       = null,
