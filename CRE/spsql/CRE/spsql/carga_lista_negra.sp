/************************************************************************/
/*  Archivo:                carga_lista_negra.sp                        */
/*  Stored procedure:       sp_carga_lista_negra                        */
...
if exists (select 1 from sysobjects where name = 'sp_carga_lista_negra' and type = 'P')
   drop proc sp_carga_lista_negra
go
...
BEGIN
	RAISERROR ('No se ha definido el parámetro BLPATH (Ruta del archivo de Lista Negra)', 13, 1);
	RETURN -1;
END
...
BEGIN
	RAISERROR ('No se ha definido el parámetro BLNAME (Nombre del archivo de Lista Negra)', 13, 1);
	RETURN -1;
END
