/************************************************************************/
/*  Archivo:                var_individual_nro_ciclo.sp                 */
/*  Stored procedure:       sp_var_individual_nro_ciclo                 */
...
if exists (select 1 from sysobjects where name = 'sp_var_individual_nro_ciclo' and type = 'P')
   drop proc sp_var_individual_nro_ciclo
go


CREATE PROC sp_var_individual_nro_ciclo(
    @s_ssn          int         = null,
    @s_ofi          smallint,
    @s_user         login,
    @s_date         datetime,
