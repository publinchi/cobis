/************************************************************************/
/*  Archivo:                var_tipo_persona.sp                         */
/*  Stored procedure:       sp_var_tipo_persona                         */
...
if exists (select 1 from sysobjects where name = 'sp_var_tipo_persona' and type = 'P')
   drop proc sp_var_tipo_persona
go



CREATE PROC sp_var_tipo_persona
		(@s_ssn        int         = null,
	     @s_ofi        smallint,
	     @s_user       login,
         @s_date       datetime,
...
SELECT @w_sp_name='sp_var_tipo_persona'
...
if @w_tramite = 0 return 0
      ...
      SELECT @w_valor_nuevo = en_subtipo 
      FROM cobis..cl_ente
