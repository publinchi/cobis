/************************************************************************/
/*  Archivo:                var_cliente_listas_negras.sp                */
/*  Stored procedure:       sp_var_cliente_listas_negras                */
...
if exists (select 1 from sysobjects where name = 'sp_var_cliente_listas_negras' and type = 'P')
   drop proc sp_var_cliente_listas_negras
go



CREATE PROC sp_var_cliente_listas_negras
		(@s_ssn        int         = null,
	     @s_ofi        smallint,
	     @s_user       login,
         @s_date       datetime,
...
SELECT @w_sp_name='sp_var_cliente_listas_negras'
...
if @w_tramite = 0 return 0
      ...
      IF EXISTS (SELECT 1 
                 FROM cob_credito..cr_lista_negra, cob_credito..cr_tramite_grupal, cobis..cl_ente
