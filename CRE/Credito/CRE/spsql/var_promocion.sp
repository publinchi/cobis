/************************************************************************/
/*  Archivo:                var_promocion.sp                            */
/*  Stored procedure:       sp_var_promocion                            */
...
if exists (select 1 from sysobjects where name = 'sp_var_promocion' and type = 'P')
   drop proc sp_var_promocion
go


create proc sp_var_promocion(
	@t_debug       		char(1)     = 'N',
