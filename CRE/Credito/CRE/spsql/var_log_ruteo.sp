/************************************************************************/
/*  Archivo:                var_log_ruteo.sp                            */
/*  Stored procedure:       sp_var_log_ruteo                            */
/*  Base de Datos:          cob_credito                                 */
/*  Producto:               Credito                                     */
/*  Disenado por:           Jose Mieles                                 */
/*  Fecha de Documentacion: 15/Oct/2019                                 */
/************************************************************************/
/*                          IMPORTANTE                                  */
...
/*                         MODIFICACIONES                               */
/*  FECHA             AUTOR            RAZON                            */
/*  15/10/21          Jose Mieles       Emision Inicial                 */
/* **********************************************************************/
use cob_credito
go

if exists (select 1 from sysobjects where name = 'sp_var_log_ruteo' and type = 'P')
   drop proc sp_var_log_ruteo
go


CREATE PROC sp_var_log_ruteo		
		 @s_ssn        int         = null,
	     @s_ofi        smallint,
	     @s_user       login,
         @s_date       datetime,
...
SELECT @w_sp_name='sp_var_log_ruteo'

	  if exists(select 1 from cob_interface..in_log_ruteo where lr_inst_actividad = @i_id_inst_act and lr_ultimo = 'S' )
