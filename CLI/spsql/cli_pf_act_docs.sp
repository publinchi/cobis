/**********************************************************************/
/*  Archivo           :   cli_pf_act_docs.sp                          */
/*  Stored procedure  :   sp_cli_pf_act_docs                          */
...
if exists (select 1
           from   sysobjects
           where  name = 'sp_cli_pf_act_docs')
           drop proc sp_cli_pf_act_docs
go

create proc sp_cli_pf_act_docs
(
  @s_ssn          int          = null,
  @s_user         login        = null,
...
select @w_sp_name = 'sp_cli_pf_act_docs'
...
update cob_pfijo..pf_operacion
   set op_ced_ruc     = @i_en_ced_ruc,
       op_descripcion = @i_en_nomlar
