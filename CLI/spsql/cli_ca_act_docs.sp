/************************************************************************/
/*  Archivo           :   cli_ca_act_docs.sp                          */
/*  Stored procedure  :   sp_cli_ca_act_docs                          */
...
if exists (select 1
           from   sysobjects
           where  name = 'sp_cli_ca_act_docs')
           drop proc sp_cli_ca_act_docs
go

create proc sp_cli_ca_act_docs
(
  @s_ssn          int          = null,
  @s_user         login        = null,
...
select @w_sp_name = 'sp_cli_ca_act_docs'
