/************************************************************************/
/*   Archivo:                 banccomunsi.sp                            */
/*   Stored procedure:        sp_check_list_banca_comunal_si            */
...
/************************************************************************/
/*                                PROPOSITO                             */
/*   Reporte Check list Legal Banca Comunal SI                          */
/************************************************************************/ 
/*                              MODIFICACIONES                          */ 
/*      FECHA           AUTOR           RAZON                           */
/*   20/Ago/2019   Edison Cajas.   Emision Inicial                      */
/************************************************************************/
use cob_cartera
go

if exists (select 1 from sysobjects where name = 'sp_check_list_banca_comunal_si')
    drop proc sp_check_list_banca_comunal_si
go

create proc sp_check_list_banca_comunal_si
(
   @t_trn              int          = 77531,
   @s_ssn              int          = null,
   @s_sesn             int          = null,
...
select @w_sp_name = 'sp_check_list_banca_comunal_si'
