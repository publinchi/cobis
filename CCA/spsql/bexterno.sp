/************************************************************************/
/*	Archivo: 		externob.sp		 		*/
/*	Stored procedure: 	sp_externo_virtual  			*/
...
if exists (select 1 from sysobjects where name = 'sp_externo_virtual')
	drop proc sp_externo_virtual
go

create proc sp_externo_virtual (
        @s_user                         login        = null,
        @s_ofi                          smallint     = null,
...
select	@w_sp_name = 'sp_externo_virtual'
...
if @w_estado = 'V' begin
   if @i_operacion = 'Q' begin
      exec @w_return = sp_consulta_pago_virtual
      @s_user   = null,
      @s_ofi    = null,
      @s_date   = null,
      @s_term   = null,
...
if @w_estado != 'V' begin
        ...
        /*CONSULTA DEL PAGO BATCH*/
        /*************************/
  if @i_operacion = 'Q' begin
    exec @w_return = sp_consulta_pago_virtual_batch
    @s_user        = @s_user,
    @s_ofi         = @s_ofi,
    @s_date        = @s_date,
    @s_term        = @s_term,
