...
if exists (select 1 from sysobjects where name = 'sp_pf_ca01')
   drop proc sp_pf_ca01
go
 

create proc sp_pf_ca01(
...
if @w_criterio <= 1 begin
   ...
   select 1, convert(varchar(15), mo_moneda), mo_descripcion
