...
if exists (select 1 from sysobjects where name = 'sp_ca01_pf')
   drop proc sp_ca01_pf
go
 

create proc sp_ca01_pf(
...
if @w_criterio <= 3 begin
   ...
   from   cobis..cl_tabla tab, cobis..cl_catalogo cat
   where  tab.tabla  = 'ca_subtipo_linea'
   and    tab.codigo = cat.tabla
