...
/************************************************************************/
/*              PROPOSITO                                               */
/*  Realiza el Manejo de Pagos Masivos                                  */
/************************************************************************/
/*                          MODIFICACIONES                              */
/*  FECHA             AUTOR                   RAZON                     */
/*  13/MAY/2020       Luis Castellanos        CDIG Emision Inicial      */
/*  18/DIC/2020       Patricio Narvaez   Tomar tipo cobro parametrizado */
...
if exists (select 1 from sysobjects where name = 'sp_pago_masivo')
...
begin
   ...
   begin 
      ...
      begin
         ...
         if @w_tipo_cobro = 'A'         
            ...
            select @w_valor = sum(am_cuota + am_gracia - am_pagado)
              from ca_dividendo, ca_amortizacion 
             where di_operacion = @w_operacionca
               and di_dividendo <= @w_dividendo_act
               and am_operacion = di_operacion
   ...
   if @w_secuencial_reg is null select @w_secuencial_reg = 0
