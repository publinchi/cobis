...
if exists (select 1 from sysobjects where name = 'sp_pcca_emp')
        drop proc sp_pcca_emp
go

create proc sp_pcca_emp (
   @t_trn                smallint = null,
