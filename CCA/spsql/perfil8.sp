...
/*    contables de CALIFICACION - CLASE - CONCEPTO                      */
/************************************************************************/
/*                             MODIFICACION                             */
/*    FECHA                 AUTOR                 RAZON                 */
/************************************************************************/
...
if exists (select 1 from sysobjects where name = 'sp_pf_ca08')
   drop proc sp_pf_ca08
go
 

create proc sp_pf_ca08(
...
if @w_criterio <= 3 begin
   ...
   insert into #ca_catalogo
   select 3,  co_concepto, co_descripcion 
