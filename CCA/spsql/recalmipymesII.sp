...
if exists(select 1 from sysobjects where name = 'sp_recalculo_mipymesII')
   drop proc sp_recalculo_mipymesII
go

create proc sp_recalculo_mipymesII
@i_operacion            int,
@i_factor               float,
@i_factor_ant           float
...
select 
@w_sp_name        = 'sp_recalculo_mipymesII',
@w_valor          = 0,
@w_porcentaje     = 0,
@w_valor_asociado = 0,
