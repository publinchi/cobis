...
if exists (select 1 from sysobjects where name = 'sp_api_transaction_loans_queries')
   drop proc sp_api_transaction_loans_queries
go

create procedure sp_api_transaction_loans_queries
/************************************************************************************/
/*  Archivo:            sp_api_transaction_loans_queries.sp                         */
/*  Stored procedure:   sp_api_transaction_loans_queries                            */
...
/*  Consulta las transacciones de una Operacion                                     */
/************************************************************************************/
/*                          MODIFICACIONES                                          */
/*  FECHA             AUTOR                   RAZON                                 */
/************************************************************************************/
...
select @w_sp_name = 'sp_api_transaction_loans_queries'
...
-- GET /loans/{loanNumber}
   --> @i_operacion = 'S' --> sp_consulta_trn       
   -->(Consulta las Transacciones Reversables de una Operaciones concreta a partir del op_banco)

exec @w_error = sp_consulta_trn 
@i_banco      = @i_banco,
@i_operacion  = 'S',
@i_api        = 'S'
