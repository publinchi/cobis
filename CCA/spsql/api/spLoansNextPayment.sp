...
go
/************************************************************************************/
/*  Archivo:            spLoansNextPayment.sp         			            */
/*  Stored procedure:   sp_api_loans_next_payment                                   */
...
if exists (select 1 from sysobjects where name = 'sp_api_loans_next_payment')
  drop proc sp_api_loans_next_payment
go
create proc sp_api_loans_next_payment
   @s_user                 char(30) 	= null,
   @s_term                 char(30) 	= null,
   @s_ofi                  INT          = null,
...
select  @w_sp_name       = 'sp_api_loans_next_payment'
...
exec sp_api_loans_next_payment
        @s_user          = 'lcastell',
        @s_term          = 'termx',
        @s_ofi           = 1,
        @i_operacion     = 'S',
