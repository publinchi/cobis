...
if exists (select 1 from sysobjects where name = 'sp_pf_ca15')
   drop proc sp_pf_ca15
go
 

create proc sp_pf_ca15(
...
if @w_criterio <= 2 begin
   ...
   insert into #ca_catalogo
   select 2, convert(varchar(15), mo_moneda), mo_descripcion
