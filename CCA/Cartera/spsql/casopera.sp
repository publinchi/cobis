/************************************************************************/
/*   Archivo:              casopera.sp                                  */
/*   Stored procedure:     sp_transaccion_cas                           */
/*   Base de datos:        cob_cartera                                  */
/*   Producto:             Credito y Cartera                            */
/*   Disenado por:         Elcira Pelaez Burbano                        */
/*   Fecha de escritura:   feb-21-2002                                  */
/************************************************************************/
/*                     IMPORTANTE                                       */
...
/************************************************************************/
/*                                PROPOSITO                             */
/*   Traslada los saldos generando una transaccion CAS.                 */
/************************************************************************/
/*                               CAMBIOS                                */
/*   FECHA     AUTOR          CAMBIO                                    */
...
/*   Jul-2015  Luis Guzman    NR-0409 Interes de Mora de Seguros        */
...
if exists (select 1 from sysobjects where name = 'sp_transaccion_cas')
   drop proc sp_transaccion_cas
go
...
create proc sp_transaccion_cas(
