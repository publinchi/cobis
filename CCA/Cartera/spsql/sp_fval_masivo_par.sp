/************************************************************************/
/*   Archivo:              sp_fval_masivo_par                           */
/*   Stored procedure:     sp_fval_masivo_par                           */
...
if exists (select 1 from sysobjects where name = 'sp_fval_adelante_par')
           drop proc sp_fval_adelante_par
go


create proc sp_fval_adelante_par 
as
...
select @w_sp_name = 'sp_fval_adelante_par'
