...
/*    contables de ESTADO CARTERA Y RUBRO                               */
/************************************************************************/
/*                             MODIFICACION                             */
/*    FECHA                 AUTOR                 RAZON                 */
/************************************************************************/
...
if exists (select 1 from sysobjects where name = 'sp_pf_ca12')
   drop proc sp_pf_ca12
go
 

create proc sp_pf_ca12(
...
if @w_criterio <= 1 begin
   ...
   select 1,  es_codigo, es_descripcion 
...
if @w_criterio <= 2 begin
   ...
   insert into #ca_catalogo
   select 2,  co_concepto, co_descripcion 
