/************************************************************************/
/*      Archivo:                contaeor.sp                             */
/*      Stored procedure:       sp_contabilidad_epia                    */
...
if exists (select 1 from sysobjects where name = 'sp_contabilidad_epia')
   drop proc sp_contabilidad_epia
go

create proc sp_contabilidad_epia
...
and valor not like ('BANCO DE LA REPUBLICA%')
order by valor
