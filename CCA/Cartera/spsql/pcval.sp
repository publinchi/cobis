...
if exists (select 1 from sysobjects where name = 'sp_pcca_val')
        drop proc sp_pcca_val
go

create proc sp_pcca_val (
   @t_trn                smallint = null,
