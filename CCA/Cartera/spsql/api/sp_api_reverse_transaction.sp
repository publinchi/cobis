...
if exists (select 1 from sysobjects where name = 'sp_api_reverse_transaction')
   drop proc sp_api_reverse_transaction
go

create procedure sp_api_reverse_transaction
/************************************************************************************/
/*  Archivo:            sp_api_reverse_transaction.sp                               */
/*  Stored procedure:   sp_api_reverse_transaction                                  */
...
/*  Reversar una Transaccion de una Operacion                                       */
/************************************************************************************/
/*                          MODIFICACIONES                                          */
/*  FECHA             AUTOR                   RAZON                                 */
/************************************************************************************/
...
select @w_sp_name = 'sp_api_reverse_transaction'
...
-- GET /loans/{loanNumber}
   --> @i_operacion  = 'R' --> sp_fecha_valor
   --> @i_secuencial = numero de transaccion a reversar      
   -->(Aplicar la Reversa de una Transaccionde una Operaciones concreta a partir del op_banco y numero de transaccion)
