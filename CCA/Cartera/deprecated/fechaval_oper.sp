...
if exists (select 1 from sysobjects where name = 'sp_fechaval_abril152015')
   drop proc sp_fechaval_abril152015
go

---ABRIL.30.2015

create proc sp_fechaval_abril152015 (
   ...
   select 
   @w_sp_name                = 'sp_fechaval_abril152015',
...
-- INICIO - REQ 089: ACUERDOS DE PAGO
   ...
   begin
      ...
      begin
         ...
         begin
            exec @w_error = sp_fechaval_abril152015 
            @s_user              = @s_user,        
...
--REVERSAR REGISTROS CONTABLES'
   ...
   begin
      if exists(select 1 from cob_credito..cr_corresp_sib
                where tabla           = 'T301'  
                  and descripcion_sib = @w_toperacion)
      begin           
