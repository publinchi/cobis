...
USE cob_custodia
go
IF OBJECT_ID('dbo.sp_inspecc1') IS NOT NULL
    DROP PROCEDURE dbo.sp_inspecc1
go
create proc dbo.sp_inspecc1  (
   @s_ssn                int      = null,
...
begin
      ...
      select @w_cliente = convert(varchar(10),cg_ente) + '  ' + cg_nombre
